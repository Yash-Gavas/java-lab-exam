...
public class department {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/dept"; // Update with your DB details
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String createDatabase = "CREATE DATABASE IF NOT EXISTS dept";
            statement.executeUpdate(createDatabase);

            String useDatabase = "USE dept";
            ...
            if (rowCount == 0) {
                String insertInitialData = "INSERT INTO Department (Dept_ID, Name, Year_Established, Head_Name, No_of_Employees) VALUES " +
                ...
                System.out.println("Initial data inserted into the Department table.");
            }
